...
bool _A_But[3], _B_But[3], _C_But[3], _Up_But[3], _Down_But[3], _Left_But[3], _Right_But[3], _D_But[3];

DigitalIn dBtn = DigitalIn(P0_2); // flash button on back of Pokitto
